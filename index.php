...
$('.SubmitButton').click(function(){ // on submit button click
    ...
    window.open("https://github.com/akshitajajoo/salt/x/"+urldata+"/"+name+"/"+urldata+"_"+name+".html") // open a new window. here you need to change the url according to your wish.
});
